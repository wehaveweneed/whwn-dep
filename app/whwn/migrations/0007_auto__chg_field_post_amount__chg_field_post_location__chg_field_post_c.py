...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.amount'
        db.alter_column('whwn_post', 'amount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Post.location'
        db.alter_column('whwn_post', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whwn.Location'], null=True, on_delete=models.DO_NOTHING))

        # Changing field 'Post.categories'
        db.alter_column('whwn_post', 'categories_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whwn.PostCategory'], null=True))

    def backwards(self, orm):

        # Changing field 'Post.amount'
        db.alter_column('whwn_post', 'amount', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Post.location'
        db.alter_column('whwn_post', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whwn.Location'], null=True))

        # Changing field 'Post.categories'
        db.alter_column('whwn_post', 'categories_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['whwn.PostCategory']))
