...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ConversationMessage.sent_via'
        db.delete_column('whwn_conversationmessage', 'sent_via')

        # Adding field 'ConversationMessage.received_via'
        db.add_column('whwn_conversationmessage', 'received_via',
        ...
        # Adding field 'StatusMessage.received_via'
        db.add_column('whwn_statusmessage', 'received_via',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)
        ...
        # Adding field 'NotificationMessage.received_via'
        db.add_column('whwn_notificationmessage', 'received_via',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)
        ...
        # Adding field 'ErrorMessage.received_via'
        db.add_column('whwn_errormessage', 'received_via',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ConversationMessage.sent_via'
        db.add_column('whwn_conversationmessage', 'sent_via',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'ConversationMessage.received_via'
        db.delete_column('whwn_conversationmessage', 'received_via')
        ...
        # Deleting field 'StatusMessage.received_via'
        db.delete_column('whwn_statusmessage', 'received_via')
        ...
        # Deleting field 'NotificationMessage.received_via'
        db.delete_column('whwn_notificationmessage', 'received_via')
        ...
        # Deleting field 'ErrorMessage.received_via'
        db.delete_column('whwn_errormessage', 'received_via')
