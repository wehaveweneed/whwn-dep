...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('whwn_conversation', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='mwg2', max_length=50),
                      keep_default=False)

        # Adding field 'Post.slug'
        db.add_column('whwn_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='i3f1x5cg', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('whwn_post', 'slug')
    ...
    models = {
        ...
        'whwn.conversation': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'n83o'", 'max_length': '50'}),
        ...
        'whwn.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'alyrp9qn'", 'max_length': '50'}),
        ...
        'whwn.volunteer': {
            ...
            'email_verification': ('django.db.models.fields.CharField', [], {'default': "'03a36e9d1820a7fabf42afdc74bbdb595e0e0d65'", 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
