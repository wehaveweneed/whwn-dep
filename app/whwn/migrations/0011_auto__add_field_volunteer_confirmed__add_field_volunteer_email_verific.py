...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.confirmed'
        db.add_column('whwn_volunteer', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Volunteer.email_verification'
        db.add_column('whwn_volunteer', 'email_verification',
                      self.gf('django.db.models.fields.CharField')(default='3e22d1690a4e2f3bb418d229cfcb3e61a397e50c', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.confirmed'
        db.delete_column('whwn_volunteer', 'confirmed')

        # Deleting field 'Volunteer.email_verification'
        db.delete_column('whwn_volunteer', 'email_verification')
    ...
    models = {
        ...
        'whwn.volunteer': {
            ...
            'email_verification': ('django.db.models.fields.CharField', [], {'default': "'835ddf4969ded217cfb8034414439c6a947af669'", 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
