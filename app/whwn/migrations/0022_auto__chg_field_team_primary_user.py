...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Team.primary_user'
        raise RuntimeError("Cannot reverse this migration. 'Team.primary_user' and its values cannot be restored.")
    ...
    models = {
        ...
        'whwn.team': {
            ...
            'conversation': ('django.db.models.fields.related.OneToOneField', [], {'default': "orm['whwn.Conversation']", 'related_name': "'conversation'", 'unique': 'True', 'to': "orm['whwn.Conversation']"}),
