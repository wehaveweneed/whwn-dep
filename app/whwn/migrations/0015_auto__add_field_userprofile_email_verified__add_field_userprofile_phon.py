...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('whwn_userprofile', 'email_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.phone_verified'
        db.add_column('whwn_userprofile', 'phone_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('whwn_userprofile', 'email_verified')

        # Deleting field 'UserProfile.phone_verified'
        db.delete_column('whwn_userprofile', 'phone_verified')
    ...
    models = {
        ...
        'whwn.conversation': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'we0a'", 'max_length': '50'}),
        ...
        'whwn.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'x474o8cs'", 'max_length': '50'}),
        ...
        'whwn.volunteer': {
            ...
            'email_verification': ('django.db.models.fields.CharField', [], {'default': "'56d211541a4b5cbce3087a9006d6d16cdf8bfed6'", 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
