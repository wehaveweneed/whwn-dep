...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.created_at'
        db.add_column('whwn_volunteer', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Volunteer.updated_at'
        db.add_column('whwn_volunteer', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.created_at'
        db.delete_column('whwn_volunteer', 'created_at')

        # Deleting field 'Volunteer.updated_at'
        db.delete_column('whwn_volunteer', 'updated_at')
    ...
    models = {
        ...
        'whwn.volunteer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '254'}),
            'email_verification': ('django.db.models.fields.CharField', [], {'default': "'50ab447aadf7677a8fa4f8ced23298b0f1097c29'", 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
