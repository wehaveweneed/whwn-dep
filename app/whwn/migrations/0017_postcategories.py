...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # default_category = orm['whwn.PostCategory'].objects.get(slug='other-supplies')

        # for post in orm['whwn.Post'].objects.all():
    ...
    models = {
        ...
        'whwn.conversation': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'hicg'", 'max_length': '50'}),
        ...
        'whwn.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'81sw1xi0'", 'max_length': '50'}),
        ...
        'whwn.postcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'svz8mmlv'", 'max_length': '50'})
        },
        'whwn.region': {
        ...
        'whwn.volunteer': {
            ...
            'email_verification': ('django.db.models.fields.CharField', [], {'default': "'cd358cae5e6ae4ca51157966f3d4e829b61a8a35'", 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
