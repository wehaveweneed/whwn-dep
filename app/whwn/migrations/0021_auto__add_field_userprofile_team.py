...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('whwn_userprofile', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, null=True, to=orm['whwn.Team']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('whwn_userprofile', 'team_id')
