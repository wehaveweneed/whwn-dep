...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('whwn_team', (
            ...
            ('primary_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='primary_user', to=orm['whwn.UserProfile'])),
            ('conversation', self.gf('django.db.models.fields.related.OneToOneField')(related_name='conversation', unique=True, to=orm['whwn.Conversation'])),
        ))
        db.send_create_signal('whwn', ['Team'])

        # Adding M2M table for field users on 'Team'
        db.create_table('whwn_team_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['whwn.team'], null=False)),
            ('userprofile', models.ForeignKey(orm['whwn.userprofile'], null=False))
        ))
        db.create_unique('whwn_team_users', ['team_id', 'userprofile_id'])

        # Deleting field 'UserProfile.default_location'
        db.delete_column('whwn_userprofile', 'default_location_id')
        ...
        db.create_table('whwn_userprofile_teams', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['whwn.userprofile'], null=False)),
            ('team', models.ForeignKey(orm['whwn.team'], null=False))
        ))
        db.create_unique('whwn_userprofile_teams', ['userprofile_id', 'team_id'])


    def backwards(self, orm):
        # Deleting model 'Team'
        db.delete_table('whwn_team')

        # Removing M2M table for field users on 'Team'
        db.delete_table('whwn_team_users')

        # Adding field 'UserProfile.default_location'
        db.add_column('whwn_userprofile', 'default_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whwn.Location'], null=True, blank=True),
                      keep_default=False)
        ...
        db.delete_table('whwn_userprofile_teams')
    ...
    models = {
        ...
        'whwn.conversation': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'2m5w'", 'max_length': '50'}),
        ...
        'whwn.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'4ue9tzbo'", 'max_length': '50'}),
        ...
        'whwn.postcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'jyb9kfet'", 'max_length': '50'})
        },
        'whwn.region': {
