...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('whwn_userprofile', 'default_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whwn.Location'], null=True),
                      keep_default=False)

        # Deleting field 'Location.deleted'
        db.delete_column('whwn_location', 'deleted')

        # Deleting field 'Location.is_default'
        db.delete_column('whwn_location', 'is_default')
    ...
    def backwards(self, orm):
        ...
        db.add_column('whwn_location', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Location.is_default'
        db.add_column('whwn_location', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
