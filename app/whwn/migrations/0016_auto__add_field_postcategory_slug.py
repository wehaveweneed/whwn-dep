...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostCategory.slug'
        db.add_column('whwn_postcategory', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='ihq8qre3', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostCategory.slug'
        db.delete_column('whwn_postcategory', 'slug')
    ...
    models = {
        ...
        'whwn.conversation': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'tgp6'", 'max_length': '50'}),
        ...
        'whwn.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'mdgvhqms'", 'max_length': '50'}),
        ...
        'whwn.postcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'wqz92sjv'", 'max_length': '50'})
        },
        'whwn.region': {
        ...
        'whwn.volunteer': {
            ...
            'email_verification': ('django.db.models.fields.CharField', [], {'default': "'baa02b63e11b1e3211bc5480f6997ee10b3e3b1b'", 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
