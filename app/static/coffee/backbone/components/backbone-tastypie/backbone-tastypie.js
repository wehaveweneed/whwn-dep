...
(function( root, factory ) {
    if ( typeof exports !== 'undefined' ) {
        return factory( exports, require( 'module' ), require( 'backbone' ), require( 'underscore' ) );
    } else if ( typeof define === 'function' && define.amd ) {
        define( 'backbone_tastypie', ['module', 'backbone', 'underscore'], function( module, Backbone, _ ) {
            return factory( root, module, Backbone, _ );
        });
    } else {
        return factory( root, root.module, root.Backbone, root._ );
    }
}( this, function( exports, module, Backbone, _ ) {
    "use strict";
